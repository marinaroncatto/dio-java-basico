...
public class ProcessoSeletivo {
	...
	static void entrandoEmContato(String candidato) {
		...
		if(atendeu)
			...
			System.out.println("NÃO CONSEGUIMOS CONTATO COM "+candidato+", NUMERO MÁXIMO DE TENTATIVAS "+tentativasRealizadas+" ATINGIDO");
	...
	static void imprimirSelecionados() {
		...
		System.out.println("Imprimindo a lista com indice de elemento");
